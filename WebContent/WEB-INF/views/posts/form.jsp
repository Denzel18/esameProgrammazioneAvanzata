...
<c:url value="/cars/save" var="action_url"/>

<div class="row justify-content-center">
	<div class="col-8">
	    <%--@elvariable id="post" type="it.univpm.advprog.blog.model.entities.Post"--%>
	    <form:form name="modulo" class="form-signin" action="${action_url}" method="POST" modelAttribute="car" onsubmit="return false">
	        ...
	        <form:textarea path="shortDescription" class="form-control mt-2" style="resize:none" rows="4"/><br>
	
	        <form:label path="longDescription">Descrizione estesa</form:label>
	        <form:textarea path="longDescription" class="form-control mt-2" style="resize:none" rows="10"/><br>
	
	        <label>Seleziona il/i Tag*
	            <select name="tagsSelected" multiple class="custom-select" >
	                <c:choose>
