...
<c:url value="/documentazione/edit/${documentoId}/allegati/link/new" var="new_link_url"/>
<c:url value="/documentazione/edit/${documentoId}/allegati/file/new" var="new_file_url"/>
